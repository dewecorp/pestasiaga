...
<div class="modal fade" id="modal_konfirmasi<?=$data['id_juri']?>" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <a href="?page=juri&aksi=hapus&id=<?=$data['id_juri']; ?>"><button class="btn btn-info waves-effect">Ya, Saya Yakin</button>
                    </a>
                    <a href="?page=juri"><button class="btn btn-danger waves-effect">Tidak</button>
                    </a>
