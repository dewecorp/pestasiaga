...
<div class="modal fade" id="modal_konfirmasi<?=$data['id_pa']?>" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <a href="?page=pesertapa&aksi=hapus&id=<?=$data['id_pa']; ?>"><button class="btn btn-info waves-effect">Ya, Saya Yakin</button></a>
                    <a href="?page=pesertapa"><button class="btn btn-danger waves-effect">Tidak</button></a>
