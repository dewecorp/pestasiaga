            ...
            <div class="card">
                ...
                <div class="body">
                    <div class=" pull-right">
                        <a href="../laporan/pesertapa_pdf.php" target="_blank" class="btn btn-default btn-sm waves-effect"><i class="fa fa-print"></i>
                            PDF</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <a data-toggle="modal" data-target="#modal_konfirmasi<?=$data['id_pa']; ?>"><button class="btn btn-danger btn-xs waves-effect"><i class="material-icons">delete</i><span>Hapus</span></button>
                                        </a>
