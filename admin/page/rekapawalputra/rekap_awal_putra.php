...
$sql_taman = $koneksi->query("SELECT * FROM tb_taman WHERE nama_taman LIKE '%PUTRA%' ORDER BY id_taman ASC");
if (!$sql_taman) {
...
if (!function_exists('map_column_putra')) {
    function map_column_putra($nama) {
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover dataTable js-basic-example dataTable">
                        ...
                        <tbody>
                            <?php
                                $no = 1;
                                $query_str = "SELECT * FROM tb_rekap RIGHT JOIN tb_peserta_pa ON tb_rekap.id_pa = tb_peserta_pa.id_pa ORDER BY no_dada ASC";
                            ...
                            <tr data-id="<?=$data['id_rekap']; ?>" data-peserta-id="<?=$data['id_pa']; ?>">
                                <td align="center"><?=$no++."."; ?></td>
                                <td align="center"><?=$data['no_dada']; ?></td>
                                <td><?=$data['pangkalan']; ?></td>
                                <?php foreach ($data_taman as $t) {
                                    $col = map_column_putra($t['nama_taman']);
