        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header bg-green">
                    <h2>
                        INPUT NILAI BARUNG PUTRA
                    </h2>
                </div>
                <div class="body">
                    <div class="pull-right">
                        <a href="?page=rekapawalputra" class="btn btn-info waves-effect"><i class="fa fa-chevron-right"></i> Kembali</a>
                    </div>
                    <br><br><br>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <button type="reset" class="btn btn-warning btn-sm waves-effect"><i class="fa fa-refresh"></i></button>
                                        </td>
                                    </tr>
                                    <?php
										}
