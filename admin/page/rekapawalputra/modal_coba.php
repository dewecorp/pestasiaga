...
?>
<div class="modal fade" id="modal_coba<?=$data['id_rekap'];?>" tabindex="-1" role="dialog">
...
$edit   = @$_POST['edit'];
if ($edit) {
$sql = $koneksi->query("UPDATE tb_peserta_pi SET no_dada='$no_dada', pangkalan='$pangkalan', pembina='$pembina' WHERE id_pi='$id'");
if ($sql) {
?>
<script>
    Swal.fire({
