                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="?page=rekapawalputri&aksi=input&id=<?=$data['id_rekap_pi']; ?>" class="btn bg-cyan btn-circle waves-effect waves-circle waves-float"><i class="material-icons">create</i><span></span></a>
                                        <!-- <a href="?page=rekapawalputri&aksi=hapus&id=<?=$data['id_rekap_pi']; ?>"
                                                    onclick="return confirm('Yakin Menghapus Data?')"
                                                    class="btn bg-red btn-circle waves-effect waves-circle waves-float"><i
                                                    class="material-icons">delete</i><span></span></a> -->
                                    </td>
                                </tr>
                                <?php
                                    }
