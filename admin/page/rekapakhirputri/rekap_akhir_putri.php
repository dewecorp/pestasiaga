            ...
            <div class="card">
                ...
                <div class="body">
                    <div class=" pull-right">
                        <a href="../laporan/prestasipi_pdf.php" target="_blank" class="btn btn-default btn-sm waves-effect"><i class="fa fa-print"></i>
                            PDF</a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover dataTable js-basic-example dataTable">
                           ...
                           RIGHT JOIN tb_peserta_pi ON tb_peserta_pi.id_pi = tb_prestasi_pi.id_pi ORDER BY nilai_akhir_pi DESC LIMIT 3");
